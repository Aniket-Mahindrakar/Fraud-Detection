...
class FraudDetectionInference:
    ...
    def read_from_kafka(self):
        ...
        kafka_bootstrap_servers = self.config["kafka"].get("bootstrap_servers")
        ...
        kafka_sasl_jaas_config = (
            f"org.apache.kafka.common.security.plain.PlainLoginModule require "
    ...
    def add_features(self, df):
        ...
        df = df.withColumn("is_night",
                           when((col("transaction_hour") >= 22) | (col("transaction_hour") < 5), 1).cast("int"))
        ...
        high_risk_merchants = self.config.get("high_risk_merchants", ["QuickCash", "GlobalDigital", "FastMerchant"])
